...
export class AddEditCourseComponent implements OnInit {
  ...
  total_clc(){
    ...
    this.course_form.controls['course_quarter_fee'].setValue((this.course_form.get('course_total_fee')?.value) / 1.33333333333333333)
    this.course_form.controls['course_monthly_fee'].setValue((this.course_form.get('course_total_fee')?.value) / 4)
  }
}